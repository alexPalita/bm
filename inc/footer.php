<footer class="container-fluid fixed-bottom px-0">
    ...
    <div class="legal collapse" id="legalNav">
        <ul class="d-flex flex-column flex-md-row justify-content-center text-center ">
            <li class="p-4">
                <a href="legal-pages.php#shipping-returns" class="p-4">Shipping&amp;Returns</a>
            </li>
            <li class="p-4">
                <a href="legal-pages.php#privacy-policy" class="p-4">Privacy Policy</a>
            </li>
            <li class="p-4">
                <a href="legal-pages.php#terms-and-conditions" class="p-4">Terms and Conditions</a>
            </li>
        </ul>
...
<script type="text/javascript" src="<?php echo $formAsset ?>"></script>
</body>
</html>
