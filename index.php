        ...
        <section  id="shoes" class="container-fluid justify-content-between d-flex flex-column">
            ...
            <div class="container mb-4">
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-6 col-lg-3 shoes">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 shoes">
                        <img src="img/bm/borderTop.svg" alt="" class="tBorder">
                        <a href="/booties" class="shoesImgContainer">
                            <figure  class="bootiesA">
                                <img src="img/bm/booties.png" alt="Booties Sketch" id="bootiesSketch">
                                <figcaption class="shoesLink text-center">BOOTIES</figcaption>
                            </figure>
                        </a>
                        <img src="img/bm/borderBottom.svg" alt="" class="bBorder">
                    </div>
